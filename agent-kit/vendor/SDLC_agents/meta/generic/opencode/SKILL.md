...
- **all_in_one_generic_agents, general-purpose:** `architect`, `build`, `build-error-resolver`, `code-reviewer`, `database-reviewer`, `doc-updater`, `docs-lookup`, `e2e-runner`, `harness-optimizer`, `loop-operator`, `planner`, `refactor-cleaner`, `security-reviewer`, `tdd-guide`
