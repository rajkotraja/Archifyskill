...
```text
/generic-agents-guide
/generic-agents-guide setup
/generic-agents-guide skills
/generic-agents-guide commands
/generic-agents-guide hooks
/generic-agents-guide install
/generic-agents-guide find: <query>
/generic-agents-guide <feature-or-file-name>
```
