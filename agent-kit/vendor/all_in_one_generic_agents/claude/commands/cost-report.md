---
description: Generate a local Claude Code cost report from the all_in_one_generic_agents cost-tracker metrics log.
argument-hint: [csv]
---
...
log that all_in_one_generic_agents's `stop:cost-tracker` hook writes.
