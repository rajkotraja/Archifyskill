...
See [rules/react/hooks.md](../../rules/generic-agents/react/hooks.md) for the full ruleset. Highlights:
...
- Rules: [rules/react/](../../rules/generic-agents/react/) — coding-style, hooks, patterns, security, testing
