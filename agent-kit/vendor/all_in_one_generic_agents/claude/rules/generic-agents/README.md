...
cp -r rules/common ~/.claude/rules/generic-agents/

# Install language-specific rules based on your project's tech stack
cp -r rules/typescript ~/.claude/rules/generic-agents/
cp -r rules/angular ~/.claude/rules/generic-agents/
cp -r rules/vue ~/.claude/rules/generic-agents/
cp -r rules/nuxt ~/.claude/rules/generic-agents/
cp -r rules/python ~/.claude/rules/generic-agents/
cp -r rules/golang ~/.claude/rules/generic-agents/
cp -r rules/web ~/.claude/rules/generic-agents/
cp -r rules/react-native ~/.claude/rules/generic-agents/
cp -r rules/swift ~/.claude/rules/generic-agents/
cp -r rules/php ~/.claude/rules/generic-agents/
cp -r rules/ruby ~/.claude/rules/generic-agents/
cp -r rules/arkts ~/.claude/rules/generic-agents/
